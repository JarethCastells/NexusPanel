...
<head>
    ...
    <style>
    /* â•â• LAYOUT ENTREGA ESTILO UBER â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
    .delivery-view {
        display: flex;
    ...
    /* Pills de productos â€” scroll horizontal */
    .dbar-products {
    ...
    /* â•â• MODAL CHAT FLOTANTE â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
    .chat-modal {
    ...
    /* Ocultar atribuciÃ³n Leaflet */
    .leaflet-control-attribution { display: none !important; }

    /* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
       RESPONSIVE FIXES â€” OPERADOR
       â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
    ...
    /* MÃ³vil: layout vertical completo */
    ...
    /* â”€â”€ MAGIA PARA ELIMINAR EL ESPACIO NEGRO (CORREGIDO) â”€â”€ */
    
    /* 1. Reglas SOLO para la computadora (El mapa actÃºa como esponja) */
...
/* =======================================================
       ðŸ”¥ CHAT A PANTALLA COMPLETA EN MÃ“VIL (CORREGIDO) ðŸ”¥
       ======================================================= */
    @media (max-width: 768px) {
        /* SOLO aplicamos el modo gigante cuando NO estÃ¡ oculto */
        ...
        /* Protege contra el Notch/CÃ¡mara del iPhone */
        .chat-modal-header { 
            padding-top: max(16px, env(safe-area-inset-top)) !important; 
            border-radius: 0 !important; 
        }
        
        /* BotÃ³n de cerrar mas grande para el dedo */
        .chat-modal-close { 
    ...
    <div class="content-area" style="padding:0;">
        ...
        <div id="tab-activos" class="tab-content <?= $tab==='activos'?'':'hidden' ?>">
            ...
            <div class="activos-layout">
                ...
                <!-- â”€â”€ VISTA ENTREGA ESTILO UBER â”€â”€ -->
                <?php if ($pedidoActivo): ?>
                <div class="delivery-view">

                    <!-- MAPA â€” ocupa todo el ancho, altura generosa -->
...
// â”€â”€ CHAT MODAL FLOTANTE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async function loadMensajesThread(reset) {
    ...
    try {
        ...
        if (!rows.length && reset) {
            body.innerHTML = '<div style="color:var(--text-muted);font-size:13px;">Sin mensajes en esta conversación.</div>';
            return;
        }
        rows.forEach((m) => {
...
// â”€â”€ MAPA OPERADOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ GPS OPERADOR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
